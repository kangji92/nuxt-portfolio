...
<template>
  <div class="project-detail">
    <div class="container">
      <div class="prj-intro">
        <div class="inner">
          <h1 class="prj-info__ttl" v-html="$t('project.ttl_nexess')"></h1>
          <p class="sub-ttl">sub-ttl</p>
          <div class="prj-intro__info">
            <dl>
              <dt>dd : </dt>
              <dd>dd
              </dd>
          ...
          <div class="col">
            ...
            <div class="style-guide fonts">
              ...
              <div class="fonts-wrap">
                <ul>
                  <li>
                    <p>교보생명 Font SemiBold</p>
                  </li>
                  <li>
                    <p>교보생명 Font Bold</p>
                  </li>
                  <li>
                    <p>교보생명 Font Reguler</p>
                  </li>
                  <li>
                    <p>교보생명 Font Lignt</p>
                  </li>
      ...
      <section class="prj-preview">
        <div class="inner">
          ...
          <article>
            <p class="visual__ttl">Individual UI</p>
            <div class="visual-box">
              <div class="mockup_sub">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
